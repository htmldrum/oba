...
ActiveRecord::Schema.define(version: 20160909073124) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.decimal  "point_earn_rate", precision: 8, scale: 2
  end
  ...
  add_index "users", ["pin"], name: "index_users_on_pin", unique: true, using: :btree
